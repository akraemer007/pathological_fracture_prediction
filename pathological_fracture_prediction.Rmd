...
# library(caret)
set.seed(1991)
trainIndex <- caret::createDataPartition(df$result, p = .1, 
                                         list = FALSE, 
                                         times = 1)
...
# I really don't know what I'm trying to do her anymore. I am very sleepy.
# df %>% 
#   filter(result == 'yes') %>% 
...
set.seed(1991)  
model_nb_2 <- NaiveBayes(result~., data=train_nb_2)
...
I think tomorrow I'll come at this again. I'll try to functionalize some of the work I'm doing here.
